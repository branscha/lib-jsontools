...
% REGEXP RULE
\ruledef{\rulename{regexp}}{\begin{itemize} \item \param{pattern} A regexp pattern.\end{itemize}}{For strings, requires a predefined format according to the regular expression.}
