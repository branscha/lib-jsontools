...
public class ObjectHelperMeta implements SerializeHelper {
    ...
    @Override
    public void renderValue(Object aObj, JSONObject aObjectElement, JSONSerializer aMarshall, HashMap<Object, Object> aPool) throws JSONSerializeException {
    ...
    @Override
    public Object parseValue(JSONObject aObjectElement, JSONSerializer aMarshall, HashMap<Object, Object> aPool) throws JSONSerializeException {
        final String option = (String) aMarshall.getSerializeOption(JSONSerializer.OPTION_OBJECTSERIALIZE, "property");
